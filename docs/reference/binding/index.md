...
| <a href='funcs/indexf.html' >Index Function </a>   | index() | Will return the current (zero based) value of the loop over a collection within the document processing.|
| <a href='funcs/lastWhere.html' ><del>Last Where Function</del></a>   | lastwhere(collection, selectExpr) | **TBC**: Will return the last entry of the collection or array where the second expression results in a value considered to be true. |
